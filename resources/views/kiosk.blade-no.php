  ...
  el.innerHTML = `
    ...
    <form id="csm-demographics" novalidate>
      ...
      <div class="d-flex justify-content-end mt-4">
        <button type="submit" class="btn btn-warning text-dark fw-semibold">NEXT</button>
      </div>
    </form>
  `;
...
function finalizeSurvey() {
  ...
  // Ensure booking metadata is also set (in case it's not already populated)
  surveyData.employee_no = surveyData.employee_no || '';
  surveyData.office_id = surveyData.office_id || 0;
  surveyData.service_id = surveyData.service_id || 0;
  surveyData.customer_type = surveyData.customer_type || '';
