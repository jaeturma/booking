...
<head>
  ...
  .form-check-input.radio-gold:checked {
    ...
    <style>
        ...
        .main-content { flex: 1; display: flex; flex-direction: column; align-items: center; padding: 2rem; }
        .modal-content { margin: auto; }
        .banner { width: 100%; max-height: 300px; object-fit: cover; margin: 2rem 0; }
        footer { background: #343a40; color: #fff; text-align: center; padding: 1rem; position: static; width: 100%; }
    </style>
...
<body>
  ...
  <!-- Header -->
    ...
    <div class="text-center">
        <img src="{{ asset('images/banner.jpg') }}" alt="Banner" class="banner">
    </div>
    ...
    <div class="tab-pane fade show active" id="panel-demographics" role="tabpanel">
      <div class="row g-4 fs-4">
        ...
        <div class="col-md-4">
          ...
          <input type="tel" class="form-control" name="contact" value="09xxxxxxxxx"
...
function finalizeSurvey() {
  ...
  submitSurvey();
    ...
    <footer>
        &copy; 2025 Your Organization Name
    </footer>
